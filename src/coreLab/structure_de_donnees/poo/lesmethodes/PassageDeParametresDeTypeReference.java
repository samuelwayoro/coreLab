package coreLab.structure_de_donnees.poo.lesmethodes;
...
public class PassageDeParametresDeTypeReference {
	...
	public static void main(String[] args) {
		 ...
		 * passé par référence... c'est a dire que les traitements effectués sur eux ont
		 * un impact direct sur les valeurs.
		 * 
		 * Par contre le passage de paramètres de type primitifs sont passés par
		 * valeurs...
		 * 
		 * c'est à dire que les traitements effectués sur eux n'ont aucun n'impact sur
		 * leurs valeurs de départ car ils sont copiés localement a les méthodes ou
		 * elles sont passés.
		 */
