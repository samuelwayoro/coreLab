...
--> LES CONSUMER<T> : 
-----------------------
Elle contient une méthode accept(T t) qui évalue une action sur un argument donné et QUI NE RETOURNE RIEN .
...
Par exemple afficher chaque element dans la sortie standart ou enregistrer chaque element en base de données . 
 ...
 Exemple : implémentation d'une Consumer<T> de java.util
 -------- 
